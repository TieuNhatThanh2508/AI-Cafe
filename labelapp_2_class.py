...
# --- Cấu hình ---
image_folder = "Output_each_bean"
labels = ["Normal", "Error", "Error image"]
output_csv = "labels_2_class.csv"
...
for i, label in enumerate(labels):
    btn = tk.Button(root, text=f"{i+1} - {label}", width=20, command=lambda l=label: assign_label(l))
    btn.pack(pady=1)
